...
class CocoPoseNet(chainer.Chain):
    ...
    def __init__(self):
        super(CocoPoseNet, self).__init__(
            ...
            conv5_5_CPM_L1=L.Convolution2D(in_channels=512, out_channels=22, ksize=1, stride=1, pad=0),
            ...
            conv5_5_CPM_L2=L.Convolution2D(in_channels=512, out_channels=13, ksize=1, stride=1, pad=0),

            # stage2
            #Mconv1_stage2_L1=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage2_L1=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage2_L1=L.Convolution2D(in_channels=128, out_channels=22, ksize=1, stride=1, pad=0),
            #Mconv1_stage2_L2=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage2_L2=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage2_L2=L.Convolution2D(in_channels=128, out_channels=13, ksize=1, stride=1, pad=0),

            # stage3
            #Mconv1_stage3_L1=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage3_L1=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage3_L1=L.Convolution2D(in_channels=128, out_channels=22, ksize=1, stride=1, pad=0),
            #Mconv1_stage3_L2=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage3_L2=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage3_L2=L.Convolution2D(in_channels=128, out_channels=13, ksize=1, stride=1, pad=0),

            # stage4
            #Mconv1_stage4_L1=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage4_L1=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage4_L1=L.Convolution2D(in_channels=128, out_channels=22, ksize=1, stride=1, pad=0),
            #Mconv1_stage4_L2=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage4_L2=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage4_L2=L.Convolution2D(in_channels=128, out_channels=13, ksize=1, stride=1, pad=0),

            # stage5
            #Mconv1_stage5_L1=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage5_L1=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage5_L1=L.Convolution2D(in_channels=128, out_channels=22, ksize=1, stride=1, pad=0),
            #Mconv1_stage5_L2=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage5_L2=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage5_L2=L.Convolution2D(in_channels=128, out_channels=13, ksize=1, stride=1, pad=0),

            # stage6
            #Mconv1_stage6_L1=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage6_L1=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage6_L1=L.Convolution2D(in_channels=128, out_channels=22, ksize=1, stride=1, pad=0),
            #Mconv1_stage6_L2=L.Convolution2D(in_channels=185, out_channels=128, ksize=7, stride=1, pad=3),
            Mconv1_stage6_L2=L.Convolution2D(in_channels=163, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage6_L2=L.Convolution2D(in_channels=128, out_channels=13, ksize=1, stride=1, pad=0),
        )
